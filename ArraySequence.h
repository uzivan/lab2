...
//    int BinSearch(T item) override
//    {
//
//        return this->binSearch(item,0,this->GetLength()-1);
//    }
//
//private:
//    int binSearch(T item, int right, int left) {
//
//        if (this->Get(right) == item)
//            return right;
//        if (this->Get(left) == item)
//            return left;
//        int middle = right + (left - right) / 2;
//        if(right >= middle)
//            return -1;
//        if (this->Get(middle) == item)
//            return middle;
//
//        if(this->Get(middle) < item)
//            return binSearch(item,middle,left);
//        if(this->Get(middle) > item)
//            return binSearch(item,right,middle);
//    }
};